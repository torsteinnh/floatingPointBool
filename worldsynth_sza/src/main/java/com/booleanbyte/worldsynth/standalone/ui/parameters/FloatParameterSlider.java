...
public class FloatParameterSlider extends JPanel {
	private static final long serialVersionUID = 5315612461487500066L;
	...
	public FloatParameterSlider(String lable, float low, float high, float initValue, int sliderRes) {
		this(lable, low, high, initValue, sliderRes, 1.0f);
	}
	
	public FloatParameterSlider(String lable, float low, float high, float initValue, int sliderRes, float rescale) {
		...
		parameterSlider.addChangeListener(new ChangeListener() {
			...
			public void stateChanged(ChangeEvent e) {
				...
				value = (float) map((double) parameterSlider.getValue(), 0.0, dSliderRes, dLow, dHigh);
